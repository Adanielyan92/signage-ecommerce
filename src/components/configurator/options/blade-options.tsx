...
interface BladeOptionsProps {
  wizardStep: number | null;
}

export function BladeOptions({ wizardStep }: BladeOptionsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Step 1: Text & Font — Blade signs have no text */}
      {wizardStep === 1 && (
        <div className="rounded-lg border border-blue-100 bg-blue-50/50 px-4 py-6 text-center">
          <p className="text-sm text-neutral-600">
            Blade signs don&apos;t require text input. Continue to the next step to set dimensions.
          </p>
        </div>
      )}
      ...
      {/* Step 3: Style & Color — Illumination, LED, Double-Sided, Shape */}
