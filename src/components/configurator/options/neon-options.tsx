...
interface NeonOptionsProps {
  wizardStep: number | null;
}

export function NeonOptions({ wizardStep }: NeonOptionsProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Step 0: Type — Neon has only one type, show a note */}
      {wizardStep === 0 && (
        <div className="rounded-lg border border-blue-100 bg-blue-50/50 px-4 py-6 text-center">
          <p className="text-sm font-medium text-neutral-700">LED Neon Sign</p>
          <p className="mt-1 text-xs text-neutral-500">
            This is the only neon sign type. Continue to the next step.
          </p>
        </div>
      )}
      ...
      {/* Step 3: Style & Color — Neon color, backer, backer shape */}
