...
interface CabinetOptionsProps {
  wizardStep: number | null;
}

export function CabinetOptions({ wizardStep }: CabinetOptionsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Step 1: Text & Font — cabinets have no text, show a note */}
      {wizardStep === 1 && (
        <div className="rounded-lg border border-blue-100 bg-blue-50/50 px-4 py-6 text-center">
          <p className="text-sm text-neutral-600">
            Cabinet signs don&apos;t require text input. Continue to the next step to set dimensions.
          </p>
        </div>
      )}
      ...
      {/* Step 3: Style & Color — LED, Printed Face, Mounting */}
